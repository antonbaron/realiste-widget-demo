document.addEventListener("DOMContentLoaded", function(event) {
  ...
  <div class="trade-up-card">
    ...
    <a href="#realisteWidgetWrap" class="btn btn-no-transition btn-secondary scroll-to">Получить предложение за 10 сек</a>
  </div>
  ...
  tradeInButton.className = 'btn btn-no-transition btn-trade-in scroll-to';
