(() => {
  ...
  // js/config/very-botsad.js
  var very_botsad_default = {
    btn: {
      title: "\u041E\u0431\u043C\u0435\u043D \u0432\u0430\u0448\u0435\u0439 \u043A\u0432\u0430\u0440\u0442\u0438\u0440\u044B",
      parentNode: ".home-block.py-0.text-white.hero-home .btns-list.d-md-flex.justify-content-center",
      className: "realiste-widget-btn very-botsad btn"
    },
    widget: {
      title: "\u041A\u0443\u043F\u0438\u0442\u044C \u0438 \u043E\u0431\u043C\u0435\u043D\u044F\u0442\u044C \u0412\u0430\u0448\u0443 \u043A\u0432\u0430\u0440\u0442\u0438\u0440\u0443",
      url: "https://gk-osnova.realiste.ai/trade-up",
...
<div class="trade-up-col">
  ...
  window.onload = function() {
    if (pageIsLoaded("MR_GROUP")) {
      ...
      partner_template_default(very_botsad_default);
...
if(window.location.toString().indexOf('www--damacproperties--com.widget-demo.realiste.ai') > -1) {
  setTimeout(() => {
document.getElementsByClassName('community-section en')[0].insertAdjacentHTML('afterend', '<section class="around-world-section en"><div class="lazyload-wrapper "><div class="container around-world"><h2>Get the best of DAMAC</h2><div id="realisteWidget" data-widget="https://damac.realiste.io"><iframe id="realisteIframe" style="display: none;"></iframe></div><script async type="text/javascript" src="https://script.realiste-widget.ru/widget-init.js"></script></div></div></section>');
  }, 5000);
}
